...
import { FiBook, FiTruck, FiDollarSign, FiUserCheck } from "react-icons/fi"; // Importing icons
...
export default function WhyOOTMS() {
  return (
    ...
    <div className="relative flex flex-col lg:flex-row items-center justify-center bg-gradient-to-r from-gray-200 via-white to-gray-100 sm:px-10 xl:px-64 py-10 sm:py-20 gap-10">
      {/* Section Title */}
            ...
            <div className="w-full  mx-auto">
              <Card className="shadow-lg h-full transform transition duration-300 hover:scale-110 bg-gray-50">
                <div className="flex flex-col items-center text-center">
                  ...
                  <h3 className="text-xl font-semibold my-2">Find booking</h3>
            ...
            <div className="w-full mx-auto">
              <Card className="shadow-lg h-full transform transition duration-300 hover:scale-110 bg-gray-50">
                <div className="flex flex-col items-center text-center">
                  ...
                  <p className="text-gray-500">
                    Ensure safe and timely delivery with our reliable and secure
                    transport services.
                  </p>
                </div>
              </Card>
