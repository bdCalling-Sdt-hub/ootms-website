        ...
        <div>
          ...
          <Form.Item name="deliveryInstructions">
            <textarea
              ...
              className="w-96 md:w-96 lg:w-[774px] p-4 border-2 border-gray-300 rounded-xl focus:outline-none resize-none bg-shipper-input-bg placeholder-semibold py-2 "
            />
          </Form.Item>
        </div>
